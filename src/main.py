...
from preprocess.preprocess_txt import run_preprocess_notes_txt
from preprocess.preprocess_json import run_preprocess_notes_json
...
def main():
    ...
    run_preprocess_notes_txt(data_dir, preprocessed_dir)
    run_preprocess_notes_json(data_dir, preprocessed_dir)
